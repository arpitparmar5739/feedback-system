...
.CSSTableGenerator tr:nth-child(odd){ background-color:#d6d6ff; }
...
.CSSTableGenerator tr:first-child td{
		background:-o-linear-gradient(bottom, #aaaaff 5%, #5656ff 100%);	background:-webkit-gradient( linear, left top, left bottom, color-stop(0.05, #aaaaff), color-stop(1, #5656ff) );
	background:-moz-linear-gradient( center top, #aaaaff 5%, #5656ff 100% );
	filter:progid:DXImageTransform.Microsoft.gradient(startColorstr="#aaaaff", endColorstr="#5656ff");	background: -o-linear-gradient(top,#aaaaff,5656ff);
...
$query = "SELECT * FROM teacher_report ORDER BY avg DESC";
